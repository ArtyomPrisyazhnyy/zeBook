...
class HttpException {
    ...
    constructor(response, status) {
        ...
        this.status = status;
        this.logger = new logger_service_1.Logger(HttpException.name);
        this.logger.warn('DEPRECATED! Since version [4.3.2] HttpException class was moved to the @nest/core package!');
    }
    getResponse() {
