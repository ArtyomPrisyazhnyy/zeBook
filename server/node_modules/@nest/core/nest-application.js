...
const { SocketModule } = optional('@nest/websockets/socket-module') || {};
const { MicroservicesModule } = optional('@nest/microservices/microservices-module') || {};
const { NestMicroservice } = optional('@nest/microservices/nest-microservice') || {};
const { IoAdapter } = optional('@nest/websockets/adapters/io-adapter') || {};
