...
export declare const MICROSERVICES_PACKAGE_NOT_FOUND_EXCEPTION = "Unable to load @nest/microservices packages (please, make sure whether it's installed already).";
